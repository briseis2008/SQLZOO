...
from world a
where 
25000000 > ALL( select population from world b where a.continent = b.continent and population > 0)
/*
10.
...
select name, continent
from world a
where population > ALL( select 3*population from world b where a.continent = b.continent and population > 0 and a.name != b.name) 
/